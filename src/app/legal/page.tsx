...
export default function LegalPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-300 via-rose-300 to-sky-300">
      <div className="max-w-3xl mx-auto px-4 py-12 ">
        ...
        <div>
          <strong>販売URL：</strong> https://cordery.vercel.app/
        </div>
        <div>
          <strong>サービス名称：</strong> Cordely（コーデリー）
        </div>
        <div>
